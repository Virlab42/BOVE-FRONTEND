    ...
    try {
      ...
      const orderData = {
        ...
        delivery: {
          ...
          option: deliveryMethod === "moscowCourier" ? moscowDeliveryOption : null,
                      ...
                      {selectedPoint && (
                        <div className="selected-point-info">
                          <div className="selected-point-details">
                            ...
                            {selectedPoint.price && (
                              <p>
                                <strong>Бесплатная доставка осуществляется от 35 000Р, при заказе на меньшую сумму, стоимость доставки рассчитывается индивидуально исходя из адреса</strong>
                              </p>
                            )}
                          </div>
                        </div>
