  ...
  return (
    <div className="cart-item">
      <Link href={`/product/${item.id}`} className="cart-item__image-link">
        <Image src='/Home/Categories/Жилетки.jpg' width={500} height={500} alt={item.title} className="cart-item__image" />
      </Link>
